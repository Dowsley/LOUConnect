...
class USER(object):
    ...
    desc = property(_AVL.USER_desc_get, _AVL.USER_desc_set)
...
def novoNo(nome, ocupacao, cpf, email, desc, dia, mes, ano):
    return _AVL.novoNo(nome, ocupacao, cpf, email, desc, dia, mes, ano)
